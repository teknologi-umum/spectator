...
router.get('/packages', async (req, res) => {
    ...
    let packages = package.get_package_list();
...
router.post('/packages', async (req, res) => {
    ...
    // Fetch package. This `pkg` contains the Package class.
    ...
    try {
        // This is the part where the package is being installed
        // See ../package.js -> Package -> install()
