...
class PersonalInfo$Type extends MessageType<PersonalInfo> {
  constructor() {
    super("session.PersonalInfo", [
      ...
      {
        no: 3,
        name: "hours_of_practice",
        kind: "scalar",
        T: 5 /*ScalarType.INT32*/
      },
      {
        no: 4,
        name: "familiar_languages",
        kind: "enum",
        repeat: 1 /*RepeatType.PACKED*/,
        T: () => ["enums.Language", Language]
      }
    ]);
  }
...
class Exam$Type extends MessageType<Exam> {
  constructor() {
    super("session.Exam", [
      ...
      {
        no: 3,
        name: "answered_question_numbers",
        kind: "scalar",
        repeat: 1 /*RepeatType.PACKED*/,
        T: 5 /*ScalarType.INT32*/
      }
      ...
      switch (fieldNo) {
        ...
        case /* repeated session.Question questions */ 2:
          message.questions.push(
            Question.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
