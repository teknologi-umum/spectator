...
export interface TestResult {
    ...
    result: {
        ...
        oneofKind: "invalidInput";
        /**
         * @generated from protobuf field: session.TestResult.InvalidInput invalid_input = 6;
         */
        invalidInput: TestResult_InvalidInput;
    } | {
        oneofKind: undefined;
    };
}
...
/**
 * @generated from protobuf message session.TestResult.InvalidInput
 */
export interface TestResult_InvalidInput {
    /**
     * @generated from protobuf field: string stderr = 1;
     */
    stderr: string;
...
class TestResult$Type extends MessageType<TestResult> {
    constructor() {
        super("session.TestResult", [
            ...
            { no: 6, name: "invalid_input", kind: "message", oneof: "result", T: () => TestResult_InvalidInput }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* session.TestResult.RuntimeError runtime_error */ 5:
                    ...
                    break;
                case /* session.TestResult.InvalidInput invalid_input */ 6:
                    message.result = {
                        oneofKind: "invalidInput",
                        invalidInput: TestResult_InvalidInput.internalBinaryRead(reader, reader.uint32(), options, (message.result as any).invalidInput)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: TestResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* session.TestResult.InvalidInput invalid_input = 6; */
        if (message.result.oneofKind === "invalidInput")
            TestResult_InvalidInput.internalBinaryWrite(message.result.invalidInput, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class TestResult_InvalidInput$Type extends MessageType<TestResult_InvalidInput> {
    constructor() {
        super("session.TestResult.InvalidInput", [
            { no: 1, name: "stderr", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<TestResult_InvalidInput>): TestResult_InvalidInput {
        const message = { stderr: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<TestResult_InvalidInput>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TestResult_InvalidInput): TestResult_InvalidInput {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: TestResult_InvalidInput, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string stderr = 1; */
        if (message.stderr !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.stderr);
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message session.TestResult.InvalidInput
 */
export const TestResult_InvalidInput = new TestResult_InvalidInput$Type();
// @generated message type with reflection information, may provide speed optimized methods
