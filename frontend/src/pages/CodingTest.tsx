...
export class Q1 extends Component {
    ...
    const response = await fetch(
      "https://judge0-ce.p.rapidapi.com/submissions",
      {
        ...
        headers: {
          ...
          "x-rapidapi-key":
            "6e061ff853mshd93ec34cf96e638p1d4e48jsnbe918de0e2bb", // Get yours for free at https://rapidapi.com/judge0-official/api/judge0-ce/
  ...
  handleKeyDown = (event) => {
    ...
    const currentTime =
      "Hour " + hour + " : " + min.substr(-2) + " : " + sec.substr(-2);
  ...
  handleDelete = (event) => {
    ...
    this.setState({
      ...
      countDelete: this.state.countDelete + 1
    });
    console.log("Delete");
  };
  ...
  handleOnIdle = (event) => {
    ...
    console.log(
      "total idle time ",
      this.idleTimer.getTotalIdleTime() / 1000 + "s"
    );
    console.log(
      "total active time ",
      this.idleTimer.getTotalActiveTime() / 1000 + "s"
    );
        ...
        >
          ...
          <div className="col">
            ...
            <div className="rounded square-lg questions">
              <p>
                print the song twinkle twinkle little star by only using 2
                variables
              </p>
            ...
            <div className="text-center">
              <div className="questionNo">
                <button
                  ...
                  onClick={(event) => (window.location.href = "/Q1")}
                >
                  1
                </button>
                &nbsp;&nbsp;
                <button
                  type="button"
                  className="btn btn-outline-info"
                  onClick={(event) => (window.location.href = "/Q2")}
                >
                  2
                </button>
                &nbsp;&nbsp;
                <button
                  type="button"
                  className="btn btn-outline-info"
                  onClick={(event) => (window.location.href = "/Q3")}
                >
                  3
                </button>
                &nbsp;&nbsp;
                <button
                  type="button"
                  className="btn btn-outline-info"
                  onClick={(event) => (window.location.href = "/Q4")}
                >
                  4
                </button>
                &nbsp;&nbsp;
                <button
                  type="button"
                  className="btn btn-outline-info"
                  onClick={(event) => (window.location.href = "/Q5")}
                >
                  5
                </button>
                &nbsp;&nbsp;
                <button
                  type="button"
                  className="btn btn-outline-info"
                  onClick={(event) => (window.location.href = "/Q6")}
                >
                  6
                </button>
                &nbsp;&nbsp;
