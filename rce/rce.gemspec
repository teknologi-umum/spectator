...
Gem::Specification.new do |spec|
  ...
  spec.summary = "RCE service with gRPC support"
  spec.description = "Remote Execution Engine service with gRPC support"
  ...
  spec.metadata["changelog_uri"] = "https://github.com/teknologi-umum/spectator/blob/master/CHANGELOG.md"
