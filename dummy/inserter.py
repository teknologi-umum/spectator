...
def main():
    ...
    with open("generated/user_personal.json") as f:
        ...
        with client.write_api(batch_size=len(users),write_options=ASYNCHRONOUS) as write_api:
            write_api.write(influx_bucket,influx_org,users)
    ...
    with open("generated/events.json") as f:
        ...
        with client.write_api(batch_size=len(events),write_options=ASYNCHRONOUS) as write_api:
            write_api.write(influx_bucket,influx_org,events)
