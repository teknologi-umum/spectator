...
const (
	...
	// MeasurementMouseDistanceTraveled is a measurement that does not exists
	// on the InfluxDB yet it is used to denote that this measurement
	// contains calculation of mouse distance traveled per question number
	// and per session.
	MeasurementMouseDistanceTraveled = "mouse_distance_traveled"
)
